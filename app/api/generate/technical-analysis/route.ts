...
${typeof nextEarnings === 'object' && nextEarnings.revenue_estimate ? `- Revenue Estimate: ${formatRevenue(nextEarnings.revenue_estimate)}` : ''}
${typeof nextEarnings === 'object' && nextEarnings.revenue_prior ? `- Previous Revenue: ${formatRevenue(nextEarnings.revenue_prior)}` : ''}
