...
- SECOND PARAGRAPH (optional, if Context Brief provided): Provide the WHY and detailed reasoning from the Context Brief. If the source (e.g., "Schwab Network", "analysts at [Firm]") was mentioned by name in the Lead paragraph, DO NOT repeat the source name here. Instead, refer to them as "The analysts", "The report", "The analysis", or "This thesis" to avoid repetition. Focus on explaining the detailed reasoning, key arguments, or specific insights (e.g., "Azure's strategic edge", "lack of downside risk", "offense vs. defense strategy") without re-introducing the source by name. Do NOT just list events - integrate them naturally into the narrative about why the stock is moving.
